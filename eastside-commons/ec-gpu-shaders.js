...
layout(location=3) out vec4 outPID;
...
void main() {
  ...
  outPID = vec4(texture(uPID, vUV).r, 0.0, 0.0, 1.0); // PID passthrough — invariant doesn't change it
}`;
...
void main() {
  ...
  outPID = vec4(texture(uPID, vUV).r, 0.0, 0.0, 1.0);
}`;
